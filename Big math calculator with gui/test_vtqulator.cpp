...
private slots:
	...
	void testAdd_VTmath();
	void testExponentiation_VTmath();
	void testMultiplication_VTmath();
	void testDivision_VTmath();
	void testSubtract_VTmath();
	void testPrintStack_VTmath();
	void testPopStack_VTmath();
	void testDuplicate_VTmath();
	void testReverse_VTmath();
	void testStackSize_VTmath();
	void testDigitLength_VTmath();
...
{
	auto op3 = gui.findChild<QCheckBox *>("Mode_Normal_VTmath");
	QVERIFY2(op3, "Could not find widget with name: 'Mode_Normal_VTmath'");
...
void TestVtqulator::testAdd_VTmath()
{
	auto output = gui.findChild<QPlainTextEdit *>("Output_window");
	QVERIFY2(output, "Could not find widget with name: 'Output_window'");
	...
	QVERIFY2(result == "20000000 3462 + p\n20003462\n", "Output of testAdd_VTmath() does not MATCH!");
	output->clear();
}

void TestVtqulator::testSubtract_VTmath()
{
	auto output = gui.findChild<QPlainTextEdit *>("Output_window");
	QVERIFY2(output, "Could not find widget with name: 'Output_window'");
	...
	QVERIFY2(result == "20000000 3462 - p\n19996538\n", "Output of testSubtract_VTmath() does not MATCH!");
	output->clear();
}

void TestVtqulator::testMultiplication_VTmath()
{
	auto output = gui.findChild<QPlainTextEdit *>("Output_window");
	QVERIFY2(output, "Could not find widget with name: 'Output_window'");
	...
	QVERIFY2(result == "20000 3462 * p\n69240000\n", "Output of testMultiplication_VTmath() does not MATCH!");
	output->clear();
}

void TestVtqulator::testDivision_VTmath()
{
	auto output = gui.findChild<QPlainTextEdit *>("Output_window");
	QVERIFY2(output, "Could not find widget with name: 'Output_window'");
	...
	QVERIFY2(result == "20000000 3462 / p\n5777\n", "Output of testDivision_VTmath() does not MATCH!");
	output->clear();
}

void TestVtqulator::testExponentiation_VTmath()
{
	auto output = gui.findChild<QPlainTextEdit *>("Output_window");
	QVERIFY2(output, "Could not find widget with name: 'Output_window'");
	...
	QVERIFY2(result == "_20 7 ^ p\n-1280000000\n", "Output of testExponentiation_VTmath() does not MATCH!");
	output->clear();
}

void TestVtqulator::testPrintStack_VTmath()
{
	auto output = gui.findChild<QPlainTextEdit *>("Output_window");
	QVERIFY2(output, "Could not find widget with name: 'Output_window'");
	...
	QVERIFY2(result == "_20 74 82 7 f\n7\n82\n74\n-20\n", "Output of testPrintStack_VTmath() does not MATCH!");
	output->clear();
}

void TestVtqulator::testPopStack_VTmath()
{
	auto output = gui.findChild<QPlainTextEdit *>("Output_window");
	QVERIFY2(output, "Could not find widget with name: 'Output_window'");
	...
	QVERIFY2(result == "_20 74 82 7 P f\n82\n74\n-20\n", "Output of testPopStack_VTmath() does not MATCH!");
	output->clear();
}

void TestVtqulator::testDuplicate_VTmath()
{
	auto output = gui.findChild<QPlainTextEdit *>("Output_window");
	QVERIFY2(output, "Could not find widget with name: 'Output_window'");
	...
	QVERIFY2(result == "_20 74 82 7 d f\n7\n7\n82\n74\n-20\n", "Output of testDuplicate_VTmath() does not MATCH!");
	output->clear();
}

void TestVtqulator::testReverse_VTmath()
{
	auto output = gui.findChild<QPlainTextEdit *>("Output_window");
	QVERIFY2(output, "Could not find widget with name: 'Output_window'");
	...
	QVERIFY2(result == "_20 74 82 7 r f\n82\n7\n74\n-20\n", "Output of testReverse_VTmath() does not MATCH!");
	output->clear();
}

void TestVtqulator::testStackSize_VTmath()
{
	auto output = gui.findChild<QPlainTextEdit *>("Output_window");
	QVERIFY2(output, "Could not find widget with name: 'Output_window'");
	...
	QVERIFY2(result == "_20 74 82 7 z\n4\n", "Output of testStackSize_VTmath() does not MATCH!");
	output->clear();
}

void TestVtqulator::testDigitLength_VTmath()
{
	auto output = gui.findChild<QPlainTextEdit *>("Output_window");
	QVERIFY2(output, "Could not find widget with name: 'Output_window'");
	...
	QVERIFY2(result == "_20 74 82 7148 Z p\n4\n", "Output of testDigitLength_VTmath() does not MATCH!");
	output->clear();
}
...
void TestVtqulator::press_VTmath_mode()
{
	auto op = gui.findChild<QCheckBox *>("Mode_Normal_VTmath");
