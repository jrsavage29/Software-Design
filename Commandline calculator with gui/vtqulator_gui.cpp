	...
	: QWidget(parent)
{
	...
	grid->addWidget(createPrecisionGroup(), 2, 0); //initializes the precision label
	grid->addWidget(createPushButtonGroup(), 3, 0); //initializes the buttons for usage as well as their shortcuts if any.
...
void VtqulatorGui::backspaceClicked()//Used for deleting strings and chars
{
	...
	/*else
	{
		std::cout <<"Cannot backspace because there is nothing here" <<std::endl;
	}*/
