/****************************************************************************
** Meta object code from reading C++ file 'complex_widget.hpp'
**
...
#error "The header file 'complex_widget.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 13), // "updateClicked"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "ComplexWidget\0updateClicked\0"
};
...
void ComplexWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ComplexWidget *_t = static_cast<ComplexWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ComplexWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ComplexWidget.data,
      qt_meta_data_ComplexWidget,  qt_static_metacall, nullptr, nullptr}
};
